...
public sealed class EfficiencyCommand
{
    ...
    {
        return new BootstrapOptions("code-index", options_.RepoPath, [], false, true, false, false, false, false, options_.Profile, options_.TargetFramework, options_.McpServerName, options_.ToolCommandName, options_.McpProjectName, options_.McpNamespace, options_.McpAssemblyName, options_.McpProjectRelativePath, false, false, false, false, false, false, false, options_.MaxFiles, options_.MaxItems, options_.IncludePrivateMembers, false, options_.RebuildCache, ".ai/generated/inventories", "all", options_.Verbose, options_.Summary, false, options_.Timings, false, false, false, false, false, false, false, "review-risk", string.Empty, 20, false, [], true, options_.Refresh, options_.NoRefresh, options_.SampleQuery, options_.ProfileExplicit, options_.ForbiddenTerms, options_.SanitizeTerm, options_.SanitizeReplacement, options_.Strict, options_.Quick, options_.Full, options_.DefaultsSummary, options_.Budget, options_.Kind, options_.Since, options_.ChangedFiles, options_.RootPath, options_.OrgSubcommand, options_.MaxDepth, false, false, false, string.Empty, false, options_.ScriptShell);
    }

    private static BootstrapOptions CreateContextPackOptions(BootstrapOptions options_, string task_)
    {
        return new BootstrapOptions("context-pack", options_.RepoPath, [], false, true, false, false, false, false, options_.Profile, options_.TargetFramework, options_.McpServerName, options_.ToolCommandName, options_.McpProjectName, options_.McpNamespace, options_.McpAssemblyName, options_.McpProjectRelativePath, false, false, false, false, false, false, false, options_.MaxFiles, options_.MaxItems, options_.IncludePrivateMembers, false, options_.RebuildCache, ".ai/generated/inventories", "all", options_.Verbose, options_.Summary, false, options_.Timings, false, false, false, false, false, false, false, task_, string.Empty, 20, false, [], true, options_.Refresh, options_.NoRefresh, options_.SampleQuery, options_.ProfileExplicit, options_.ForbiddenTerms, options_.SanitizeTerm, options_.SanitizeReplacement, options_.Strict, options_.Quick, options_.Full, options_.DefaultsSummary, options_.Budget, options_.Kind, options_.Since, options_.ChangedFiles, options_.RootPath, options_.OrgSubcommand, options_.MaxDepth, false, false, false, string.Empty, false, options_.ScriptShell);
    }
