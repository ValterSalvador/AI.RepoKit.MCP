...
public sealed class ProcessRunner
{
    ...
    [
        ...
        (new Regex(@"(?i)\b[A-Z]:\\\\Program Files(?: \([^\\]+\))?\\\\[^\s""'<>|]+", RegexOptions.Compiled), "<local-path>"),
        ...
        (new Regex(@"(?i)\b[A-Z]:(?:\\\\|\\u005[Cc])[^\\\s""'<>|]+(?:(?:\\\\|\\u005[Cc])[^\\\s""'<>|]+)+", RegexOptions.Compiled), "<local-path>"),
        ...
        (new Regex(@"(?i)\b[A-Z]:\\Repositories\\[^\s""'<>|]+", RegexOptions.Compiled), "<repo-root>"),
        (new Regex(@"(?i)\b[A-Z]:\\Users\\[^\\\s""'<>|]+\\[^\s""'<>|]+", RegexOptions.Compiled), "<local-path>"),
        (new Regex(@"(?i)\b[A-Z]:\\[^\\\s""'<>|]+(?:\\[^\\\s""'<>|]+)+", RegexOptions.Compiled), "<local-path>"),
