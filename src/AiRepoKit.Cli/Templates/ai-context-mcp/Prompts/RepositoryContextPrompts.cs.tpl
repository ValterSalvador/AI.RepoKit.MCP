...
5. use search_context only for focused queries when needed

Avoid broad scans, local paths, secrets, and machine-specific assumptions. Prefer resources and context packs before direct file inspection.
""";
