...
VS Code custom agents under `.github/agents/*.agent.md` follow the VS Code custom agent convention. Ask and Plan are read-only, Implementer may edit files, Reviewer reviews risk, and Test Fixer focuses on build and test failures.
